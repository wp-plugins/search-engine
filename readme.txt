...
All you do is install the plugin, and index your site. You can setup cronjobs to reindex hourly, daily, weekly, or do it manually on an as needed basis. Indexing covers Full Pages as the visitor sees them. That means, Sidebars, Template code, and anything else your visitor sees is indexed.
